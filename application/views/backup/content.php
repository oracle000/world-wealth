		<div id="content">
				...
				<div id="followuscontainer">
					<div id="fuleft">
						<div id="missionwrap">
							...
							and growth responsibly as well as create lifestyle changes to reward their sheer 
							determination, continued hardwork and global competitiveness.</div>						
						</div>
					</div>
					<div id="furight">
						<div id="missionwrap">
							...
							sales while paving the way to their individual wealth and financial stability.</div>							
						</div>
					</div>
				</div>
			</div>
			...
			<div class="img-achievement" id="img-achievement">
