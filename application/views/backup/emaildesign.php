			...
			<body style='margin:0;padding;0'>
				<div id='containerty' style='height:600px;width:100%;'>
					<div id='headerreg' style='background-color:#ededed;height:100px;box-shadow:0px -5px 2px 5px;'>
						<div id='headerwrapreg' style='height:100px;width:100%;'>
							<div class='webnamewrapreg' style='float:left;'>
								<div style=\"height:100px;width:600px\">
									<img src=\"http://worldwealth.xp3.biz/css/img/companylogo-email.png\" height=\"75px\" style=\"margin-top:10px;margin-left:100px;\">
								</div>
							</div>
						</div>
					</div>
					<div id='wrapperty' style='height:400px;width:700px;margin:auto;margin-top:20px;'>
						...
						<div class='tydesc1' style=\"text-align:center;font-family:'Segoe UI';font-size:20px;font-weight:100;margin-top:20px;\"><strong>User Login</strong></div>
						<div class='logincon'>
							<div class='loginwrap' style='width:400px;margin:auto;text-align:left;'>
								<div class='tydesc3' style=\"text-align:left;font-family:'Segoe UI';font-size:16px;font-weight:100;\">Usercode : $userskey</div>
								<div class='tydesc3' style=\"text-align:left;font-family:'Segoe UI';font-size:16px;font-weight:100;\">Password : $password</div>
							</div>
						</div>
